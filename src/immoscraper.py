        ...
        try:
            ...
            if multi_get(data, "property", "location", "country") == "Belgium":
                ...
                self.property_data[self.property_key] = {
                    ...
                    "nbr_bedrooms": multi_get(data, "property", "bedroomCount"),
                    "total_area_sqm": multi_get(data, "property", "netHabitableSurface"),
                    ...
                    "fl_terrace": 1 if data["property"]["hasTerrace"] else 0,
                    "garden_sqm": (
